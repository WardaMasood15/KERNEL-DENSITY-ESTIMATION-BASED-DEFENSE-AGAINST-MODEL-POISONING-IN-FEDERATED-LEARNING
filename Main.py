...
main = tkinter.Tk()
main.title("Kernel Density Estimation-Based Defense Aganist Model Poisoining in Federated learning ") #designing main screen
...
def uploadGenuine():
    ...
    text.insert(END,"KDE Propose Accuracy : "+str(lomar_acc)+"\n\n")
    s.close()
...
def lomarAccuracy():
    ...
    labels = ['No Defence Accuracy', 'Propose KDE Defence Accuracy']
    ...
    plt.ylabel("Accuracy %")
    plt.title("No Defence & Propose KDE Defence Accuracy Comparison Graph")
    plt.xticks()
    plt.tight_layout()
    plt.show()
...
font = ('times', 16, 'bold')
title = Label(main, text='Kernel Density Estimation-Based Defense Aganist Model Poisoining in Federated learning')
...
accButton = Button(main, text="Propose KDE & No Defence Accuracy", command=lomarAccuracy)
